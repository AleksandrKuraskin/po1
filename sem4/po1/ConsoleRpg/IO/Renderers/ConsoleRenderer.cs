...
public class ConsoleRenderer : IRenderer
{
    public void Render(Game game)
    {
        ...
        var eqPanel = new Panel(
            ...
            (p.Equipment.LeftHand == p.Equipment.RightHand && p.Equipment.LeftHand != null ? "[green](Two handed)[/]\n" : "")
        ...
        var msgPanel = new Panel($"[red]{game.Logger}[/]\n\n[grey]WASD-Move, E-PickUp, Q+|0-9|-Drop, |0-9|-Equip[/]").Expand();
